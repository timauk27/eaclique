...
const categoryMap: Record<string, string> = {
    'plantao': 'PLANTÃO',
    'brasil': 'PLANTÃO', // Brasil uses same category as Plantão
    'mundo': 'PLANTÃO',  // Mundo uses same category as Plantão
    'arena': 'ARENA',
    'holofote': 'HOLOFOTE',
    'mercado': 'MERCADO',
    'pixel': 'PIXEL',
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {news.map((article) => (
                            <Link
                                ...
                                className="group bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-800"
                            >
                                {/* Image */}
                                {article.imagem_capa && (
